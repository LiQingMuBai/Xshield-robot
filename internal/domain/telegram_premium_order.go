...
type TelegramPremiumOrder struct {
	...
	Month      string    `json:"month" form:"order_no" gorm:"column:month;"`                // `db:"name"`
...
// TableName telegram_premium_order RonUsers自定义表名 telegram_premium_order
func (TelegramPremiumOrder) TableName() string {
	return "telegram_premium_order"
}
